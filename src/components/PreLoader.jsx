...
function PreLoader() {
  ...
  useEffect(() => {
    ...
    const timer2 = setTimeout(() => {
      if(logo) {
        gsap.fromTo(logo, {y: 500, opacity: 0}, {duration: 2, y: 20, opacity: 1})
      }
    ...
    <div className="pre">
     { !loaded && 
       <div className="loading-page">
         ...
         <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512"><path d="M64 32c17.7 0 32 14.3 32 32V416H288c17.7 0 32 14.3 32 32s-14.3 32-32 32H64c-17.7 0-32-14.3-32-32V64c0-17.7 14.3-32 32-32z"/></svg>
